...
Stay inside the owned paths unless the task explicitly instructs otherwise. Do not edit forbidden paths. Preserve provider defaults and temp-file behavior; LFG only controls cwd, prompt path, result path, logs, and process supervision.
