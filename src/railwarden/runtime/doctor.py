...
from railwarden.hermes.profile import generate_hermes_profile, hermes_executable
from railwarden.providers.adapters import ProviderAdapter
from railwarden.runtime.launch_setups import load_setup_env
from railwarden.runtime.session import (
    AgentInstance,
    SessionProfile,
    load_session_profile,
)
from railwarden.runtime.typed_agents import pydanticai_available
from railwarden.runtime.workflow import langgraph_available
...
def _hermes_profile_status(
    ...
    try:
        completed = subprocess.run(
            [executable, "mcp", "test", "railwarden"],
